...
class Call(PyTgCalls):
    ...
    async def join_call(
        ...
        try:
            ...
            raise AssistantErr(
                "**Telegram Sunucusu Hatası**\n\nTelegram'da bazı dahili sunucu sorunları var, Lütfen tekrar oynatmayı deneyin.\n\n Bu sorun her zaman ortaya çıkıyorsa, lütfen sesli sohbetinizi sonlandırın ve yeni bir sesli sohbet başlatın.."
            )
